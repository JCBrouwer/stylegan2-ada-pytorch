...
def make_transform(
    transform: Optional[str], output_width: Optional[int], output_height: Optional[int], resize_filter: str
...
def convert_dataset(
    ...
    for idx, image in tqdm(enumerate(input_iter), total=num_files):
        ...
        # the whole dataset.
        if (img.ndim == 2 or img.shape[2] == 1) and dataset_attrs["channels"] == 3:
            img = img[..., None][..., [0, 0, 0]]
        ...
        img.save(image_bits, format="jpeg", optimize=True)
