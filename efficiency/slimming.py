...
class SlimmingLoss(StyleGAN2Loss):
    def __init__(self, device, G_mapping, G_synthesis, D, **kwargs):
        super().__init__(device, G_mapping, G_synthesis, D, **kwargs)

    def before_backward(self):
        # do gradient-based pruning / quantization / etc. here
        pass

    def after_minibatch(self):
        # do general pruning / quantization / etc. here
        pass
    ...
    def accumulate_gradients(self, phase, real_img, real_c, gen_z, gen_c, sync, gain):
        ...
        if do_Gpl:
            ...
            loss = (gen_img[:, 0, 0, 0] * 0 + loss_Gpl).mean().mul(gain)
        ...
        if do_Dmain or do_Dr1:
            ...
            loss = (real_logits * 0 + loss_Dreal + loss_Dr1).mean().mul(gain)
